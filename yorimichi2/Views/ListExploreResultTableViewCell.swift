...
protocol ListExploreResultGoogleTableViewCellDelegate: AnyObject{
...
class ListExploreResultGoogleTableViewCell: UITableViewCell {
    static let identifier = "ListExploreResultGoogleTableViewCell"
    
    weak var delegate: ListExploreResultGoogleTableViewCellDelegate?
    
    private var viewModel: GoogleAnnotationViewModel?
    ...
    @objc private func didTapPost(){
        ...
        delegate?.listExploreResultGoogleTableViewCell(self, didTapPostWith: vm)
...
//            CGSize(width: contentView.width-postImageView.right-25-postSize, height: contentView.height)
//        )
    ...
    public func configure(with viewModel: GoogleAnnotationViewModel){
        self.viewModel = viewModel
