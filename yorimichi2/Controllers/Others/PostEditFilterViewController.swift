...
class PostEditFilterViewController: UIViewController {
    ...
    @objc private func didTapNext(){
        guard let current = imageView.image else {
            return
        }
...
//        navigationController?.pushViewController(vc, animated: true)
        //let vc = PhotoInfoEditViewController(image: current)
        let vc = PhotoEditInfoViewController()
        vc.createPhotoViewModels(image: current)
        navigationController?.pushViewController(vc, animated: true)
//        let vc = SearchLocationViewController()
//        navigationController?.pushViewController(vc, animated: true)
//        let vc = TestListViewController()
//        navigationController?.pushViewController(vc, animated: true)
//        let vc = DeclarativeListViewController()
//        navigationController?.pushViewController(vc, animated: true)
//        let vc = CustomEditViewController()
//        navigationController?.pushViewController(vc, animated: true)
    }
...
// MARK: - Collection
extension PostEditFilterViewController: UICollectionViewDelegate, UICollectionViewDataSource{
